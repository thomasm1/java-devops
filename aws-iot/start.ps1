...
cd aws-iot-device-sdk-java
mvn exec:java -pl aws-iot-device-sdk-java-samples --% -Dexec.mainClass="com.amazonaws.services.iot.client.sample.pubSub.PublishSubscribeSample" -Dexec.args="-clientEndpoint a1l57qi5byvc3h-ats.iot.us-west-2.amazonaws.com -clientId sdk-java -certificateFile ..\..\..\yoga.cert.pem -privateKeyFile ..\..\..\yoga.private.key"
