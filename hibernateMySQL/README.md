#### Hibernate using MySQL hosted on AWS RDS
...
> RDS ENDPOINT: thomas2.cs8ihlmwvzfx.us-east-1.rds.amazonaws.com
...
CREATE USER 'dbadmin'@'localhost' IDENTIFIED BY 'thomas';

GRANT ALL PRIVILEGES ON test4.customer TO 
'dbadmin'@'localhost' IDENTIFIED BY 'thomas';
 -->
 <!-- 
