package net.mavencrypto.controller;
...
import net.mavencrypto.random.GeneratedRandomIdentifier;
// thomasMilton imports
...
public class IdentifierGenerationController {
	...
	private static final Logger logger = Logger
			.getLogger("net.mavencrypto.controller.IdentifierGenerationController");
