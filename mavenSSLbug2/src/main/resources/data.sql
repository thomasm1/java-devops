...
--CREA'did3','date_3', 'author3','monthOrder3','cat33', 'title3', 'post3', 'blogcite3', 'username3');TE TABLE post(id NUMBER(10), did VARCHAR2(20), date_ VARCHAR2(20) , author VARCHAR2(20) , month_order VARCHAR2(20), cat3 VARCHAR2(20), title VARCHAR2(20), post VARCHAR2(2000), blogcite VARCHAR2(200), username  VARCHAR2(20));
                                                                                                             --DROP TABLE POST;
                                                                                                             --COMMIT;
                                                                                                             --SELECT * FROM POST;
